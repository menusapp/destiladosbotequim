-- Recria a trigger de movimentação de estoque para garantir que funciona corretamente
DROP TRIGGER IF EXISTS trigger_process_order_stock_movement ON orders;

-- Recria a função com correções
...
-- Recria a trigger
CREATE TRIGGER trigger_process_order_stock_movement
