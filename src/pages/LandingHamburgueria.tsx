...
/* ── Niche-specific copy ── */
const TYPING_WORDS: string[] = ["sua hamburgueria", "seu delivery de burgers", "sua smash burger"];
const HERO_BADGE = "Usado por mais de 200 hamburguerias";
const HERO_METRICS = [
  { value: "Até 3x", label: "mais pedidos no delivery" },
  { value: "Redução de 25%", label: "no tempo de preparo" },
  { value: "0%", label: "de comissão do iFood" },
];
const CTA_FINAL_TITLE = "Pronto para vender mais burgers sem pagar comissão?";
const PIXEL_CONTENT_NAME = "Landing Hamburgueria";
...
const painPoints = [
  { icon: AlertTriangle, pain: "Você perde pedidos porque o WhatsApp não para de tocar", solution: "Robô IA atende e finaliza pedidos 24h no WhatsApp" },
  { icon: DollarSign, pain: "Comissão do iFood corrói sua margem no smash burger", solution: "Delivery próprio com zero comissão por pedido" },
  { icon: Clock, pain: "Fila no caixa afasta cliente na hora do rush", solution: "Totem de autoatendimento e QR Code na mesa" },
  { icon: BarChart3, pain: "Você não sabe qual burger tem maior margem de lucro", solution: "CMV por produto e DRE automático" },
];
...
const sellingModes = [
  { icon: Truck, title: "Delivery de burgers", desc: "Pedidos no seu próprio link, sem comissão. Robô IA atende no WhatsApp 24h.", cta: "Criar cardápio grátis" },
  { icon: QrCode, title: "QR Code na mesa", desc: "Cliente escolhe o burger pelo celular sem precisar chamar o atendente.", cta: "Começar agora" },
  { icon: Store, title: "Retirada no balcão", desc: "Pedido rápido para quem prefere buscar. Acabe com a fila do caixa.", cta: "Ver demonstração" },
  { icon: Smartphone, title: "Totem de autoatendimento", desc: "Totem na sua loja: cliente faz o pedido sozinho e libera o caixa.", cta: "Experimentar" },
];
...
const testimonials = [
  { name: "João R.", role: "Dono de Smash Burger", text: "Saí de 20 para 80 pedidos/dia no delivery. O robô do WhatsApp vende mais que meu atendente." },
  { name: "Marcos L.", role: "The Burger Lab", text: "Larguei o iFood e economizo R$4.000/mês. Meu delivery próprio se pagou na primeira semana." },
  { name: "Paula S.", role: "Burger House", text: "O totem eliminou a fila no horário do almoço. Faturamento aumentou 60% em 2 meses." },
];

/* ── Component ── */
const LandingHamburgueria = () => {
...
export default LandingHamburgueria;
