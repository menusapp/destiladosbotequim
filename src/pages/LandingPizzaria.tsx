...
/* ── Niche-specific copy ── */
const TYPING_WORDS: string[] = ["sua pizzaria", "seu delivery de pizzas", "seu rodízio"];
const HERO_BADGE = "Usado por mais de 150 pizzarias";
const HERO_METRICS = [
  { value: "Até 2x", label: "mais pedidos na sexta e sábado" },
  { value: "Redução de 40%", label: "nas reclamações de pedido" },
  { value: "Turno noturno", label: "simplificado e sob controle" },
];
const CTA_FINAL_TITLE = "Pronto para sua pizzaria vender mais toda sexta-feira?";
const PIXEL_CONTENT_NAME = "Landing Pizzaria";
...
const painPoints = [
  { icon: AlertTriangle, pain: "Sexta à noite o telefone não para e você perde pedido", solution: "Robô IA recebe todos os pedidos simultaneamente no WhatsApp" },
  { icon: Printer, pain: "Erros de pedido na correria da noite geram retrabalho e prejuízo", solution: "Pedidos digitais direto na tela da cozinha sem erro humano" },
  { icon: DollarSign, pain: "Comissão do app de delivery come 30% da sua margem", solution: "Delivery próprio com taxa zero por pedido" },
  { icon: Utensils, pain: "Rodízio vira caos sem controle de mesa e consumo", solution: "Comanda digital por mesa com controle em tempo real" },
];
...
const sellingModes = [
  { icon: Truck, title: "Delivery de pizzas", desc: "Pedidos no seu link próprio, sem comissão. Robô IA atende todos juntos no WhatsApp.", cta: "Criar cardápio grátis" },
  { icon: QrCode, title: "QR Code na mesa", desc: "Cardápio digital para o salão. Cliente pede sem chamar o garçom.", cta: "Começar agora" },
  { icon: Utensils, title: "Comanda do rodízio", desc: "Comanda digital por mesa para controlar consumo e tempo do rodízio.", cta: "Experimentar" },
  { icon: Store, title: "Retirada no balcão", desc: "Pedido antecipado para retirada. Cliente chega e leva.", cta: "Ver demonstração" },
];
...
const testimonials = [
  { name: "Carla M.", role: "Pizzaria Bella Napoli", text: "Na sexta à noite o robô IA atende 50 clientes ao mesmo tempo. Nunca mais perdi pedido." },
  { name: "Ricardo F.", role: "Don Pizza", text: "Saí do iFood e minha margem subiu de 18% para 42% no delivery." },
  { name: "Fernanda S.", role: "Rodízio Paulista", text: "O controle de mesa no rodízio é perfeito. Sei exatamente o consumo de cada mesa em tempo real." },
];

/* ── Component ── */
const LandingPizzaria = () => {
...
export default LandingPizzaria;
