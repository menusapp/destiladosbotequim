...
/* ── Niche-specific copy ── */
const TYPING_WORDS: string[] = ["seu bar", "seu pub", "sua casa de shows"];
const HERO_BADGE = "Usado por mais de 100 bares e pubs";
const HERO_METRICS = [
  { value: "Até 35%", label: "mais consumo por mesa" },
  { value: "Menos de 2 min", label: "para fechar conta de mesa cheia" },
  { value: "Zero", label: "confusão na divisão da conta" },
];
const CTA_FINAL_TITLE = "Pronto para seu bar vender mais sem confusão?";
const PIXEL_CONTENT_NAME = "Landing Bar";
...
const painPoints = [
  { icon: DollarSign, pain: "Fechar a conta de mesa cheia no fim da noite vira confusão", solution: "Divisão de conta automática por pessoa ou por item" },
  { icon: Utensils, pain: "Garçom não consegue atender todas as mesas ao mesmo tempo", solution: "Cliente pede pelo QR Code da mesa sem chamar ninguém" },
  { icon: BarChart3, pain: "Você não sabe qual produto tem maior margem no seu bar", solution: "CMV por produto, estoque de bebidas e DRE automático" },
  { icon: CalendarCheck, pain: "Reservas de mesa feitas no WhatsApp viram bagunça", solution: "Sistema de reservas online integrado ao painel" },
];
...
const sellingModes = [
  { icon: QrCode, title: "QR Code na mesa", desc: "Cliente abre o cardápio, pede e pede de novo sem esperar o garçom.", cta: "Começar agora" },
  { icon: Utensils, title: "Comanda digital por mesa", desc: "Divisão de conta por pessoa ou por item em segundos.", cta: "Experimentar" },
  { icon: CalendarCheck, title: "Reservas online", desc: "Reservas de mesa direto no painel. Sem WhatsApp bagunçado.", cta: "Ver demonstração" },
  { icon: Truck, title: "Delivery próprio", desc: "Entrega de petiscos e bebidas com taxa zero por pedido.", cta: "Criar cardápio grátis" },
];
...
const testimonials = [
  { name: "Bruno T.", role: "Pub Dublin", text: "O QR Code na mesa aumentou o ticket médio em 40%. Cliente pede mais quando não precisa chamar garçom." },
  { name: "Amanda C.", role: "Bar da Praça", text: "Fechamento de conta que demorava 15 minutos agora leva 30 segundos. Zero confusão na divisão." },
  { name: "Felipe M.", role: "Cervejaria Artesanal", text: "Controlo o estoque de bebidas em tempo real. Acabou o sumiço de produto." },
];
