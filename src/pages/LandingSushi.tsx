...
/* ── Niche-specific copy ── */
const TYPING_WORDS: string[] = ["seu restaurante japonês", "seu delivery de sushi", "sua temakeria"];
const HERO_BADGE = "Usado por mais de 80 restaurantes japoneses";
const HERO_METRICS = [
  { value: "Até 50%", label: "mais pedidos no delivery" },
  { value: "Cardápio visual", label: "que vende sozinho" },
  { value: "Rodízio japonês", label: "simplificado e sob controle" },
];
const CTA_FINAL_TITLE = "Pronto para seu restaurante japonês vender mais combinados?";
const PIXEL_CONTENT_NAME = "Landing Sushi";
...
const painPoints = [
  { icon: QrCode, pain: "Cardápio em papel não mostra as fotos dos combinados", solution: "Cardápio digital visual com fotos profissionais de cada peça" },
  { icon: Utensils, pain: "Rodízio japonês sem controle vira prejuízo", solution: "Controle de rodízio por tempo e consumo por mesa em tempo real" },
  { icon: AlertTriangle, pain: "Pedidos de combinado por WhatsApp chegam errados", solution: "Robô IA recebe pedido com todas as especificações sem erro" },
  { icon: DollarSign, pain: "Comissão do delivery app corrói sua margem já apertada", solution: "Delivery próprio com taxa zero — combinados entregues sem desconto" },
];
...
const sellingModes = [
  { icon: Truck, title: "Delivery de sushi", desc: "Pedidos de combinados no seu link, sem comissão. Robô IA recebe sem erro.", cta: "Criar cardápio grátis" },
  { icon: QrCode, title: "QR Code na mesa", desc: "Cardápio visual com fotos profissionais de cada peça.", cta: "Começar agora" },
  { icon: Utensils, title: "Comanda do rodízio japonês", desc: "Controle por tempo e consumo de cada mesa em tempo real.", cta: "Experimentar" },
  { icon: Store, title: "Retirada no balcão", desc: "Combinados prontos para retirada na hora marcada.", cta: "Ver demonstração" },
];
...
const testimonials = [
  { name: "Yuki T.", role: "Sushi Matsuri", text: "O cardápio digital com fotos aumentou o ticket médio dos combinados em 55%." },
  { name: "Daniel L.", role: "Temakeria Osaka", text: "O controle do rodízio revolucionou. Sei o consumo de cada mesa e acabou o prejuízo." },
  { name: "Priya S.", role: "Sushi House", text: "Delivery próprio triplicou os pedidos. Larguei o iFood e a margem subiu 30%." },
];
